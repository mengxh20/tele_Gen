...
export RECOVER_OUTPUT_DIR=/data/heli/code/tele_Gen/reconstruct/experiments/recover_sparse_refresh_1w_x0int8_headsoft5_tailp4_flowonly_bs2_from_ep120
export CHECKPOINT_EVERY_STEPS="${CHECKPOINT_EVERY_STEPS:-500}"

echo "[INFO] role=master addr=${MASTER_ADDR}:${MASTER_PORT} nnodes=${NNODES} rank=${NODE_RANK}"
