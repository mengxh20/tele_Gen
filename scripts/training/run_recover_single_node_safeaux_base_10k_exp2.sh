...
export RECOVER_OUTPUT_DIR="${RECOVER_OUTPUT_DIR:-/data/heli/code/tele_Gen/reconstruct/experiments2/recover_sparse_refresh_1w_x0int8_headsoft5_tailp4_base_safeaux10k}"
export MAX_STEPS="${MAX_STEPS:-10000}"
export CHECKPOINT_EVERY_STEPS="${CHECKPOINT_EVERY_STEPS:-1000}"
export AUX_LOSS_WARMUP_STEPS="${AUX_LOSS_WARMUP_STEPS:-2000}"
export AUX_LOSS_RAMP_STEPS="${AUX_LOSS_RAMP_STEPS:-8000}"

echo "[INFO] experiment=base_safeaux10k_exp2"
