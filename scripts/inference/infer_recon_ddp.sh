...
torchrun \
    ...
    reconstruct/gen2recon.py reconstruct \
    --num_inference_steps 1 \
    --input_path reconstruct/latents \
    --lora_path reconstruct/gen2recon_runs \
    --output_latent_path reconstruct/recovered_latents \
    --output_video_path reconstruct/recovered_videos_lowbpp \
    "$@"
