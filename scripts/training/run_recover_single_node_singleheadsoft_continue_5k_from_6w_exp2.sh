...
export INIT_CHECKPOINT_DIR="${INIT_CHECKPOINT_DIR:-/data/heli/code/tele_Gen/reconstruct/experiments2/recover_sparse_refresh_1w_x0int8_headsoft5_tailp4_base_safeaux_continue10k_from_step50000_section7_anchor1_steps24/checkpoints/epoch_0001_step_00010000}"
export RECOVER_OUTPUT_DIR="${RECOVER_OUTPUT_DIR:-/data/heli/code/tele_Gen/reconstruct/experiments2/recover_sparse_refresh_1w_x0int8_headsoft5_tailp4_singleheadsoft_budget0065_continue5k_from_step60000_section7_anchor1_steps24}"

export MAX_STEPS="${MAX_STEPS:-5000}"
export CHECKPOINT_EVERY_STEPS="${CHECKPOINT_EVERY_STEPS:-1000}"

# Structural adaptation: single refresh changes from full head anchor to cheap soft-pool head.
# Use a short aux warmup/ramp to avoid abruptly pushing the 6w weights under the new condition mix.
export AUX_LOSS_WARMUP_STEPS="${AUX_LOSS_WARMUP_STEPS:-500}"
export AUX_LOSS_RAMP_STEPS="${AUX_LOSS_RAMP_STEPS:-2000}"
...
echo "[INFO] experiment=singleheadsoft_budget0065_continue5k_from_6w_exp2"
