...
EXP_DIR="${EXP_DIR:-/data/heli/code/tele_Gen/reconstruct/experiments2/recover_sparse_refresh_1w_nochunk_singleheadsoft_budget0065_base10k_section7_anchor1_steps24}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-${EXP_DIR}/checkpoints/epoch_0001_step_00010000}"
OUTPUT_DIR="${OUTPUT_DIR:-${EXP_DIR}/recover_outputs_videoSRC01_04_nochunk149_step10000_singleheadsoft_budget0065_x0int8sf1_sheadsoft5_dheadsoft5_tailp4}"
