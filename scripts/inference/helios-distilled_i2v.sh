CUDA_VISIBLE_DEVICES=6,7 python infer_helios.py \
    --base_model_path "/data/mengxh/MODELS/BestWishYSH/HeliosDistillede" \
    --transformer_path "/data/mengxh/MODELS/BestWishYSH/HeliosDistillede" \
    --sample_type "i2v" \
    ...
    --enable_compile \
    --output_folder "/data/mengxh/codes/Helios/output_helios/helios-distilled"
